...
# from cross_vali_data_convert_merge import window_size
# from cross_vali_data_convert_merge import threshold
# from cross_vali_data_convert_merge import slide_size
...
#data shuffle
print("x_bed.shape: ",x_bed.shape)
print("y_bed.shape: ",y_bed.shape)
print("x_bed: ",x_bed)
print("y_bed: ",y_bed)
######################## - by allen
